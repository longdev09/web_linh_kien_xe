        ...
        public JsonResult ChonMua(string msp)
        {
            ...
            if (Session["ttDangNhap"]!= null)
            {
                ...
                else
                {
                    ...
                    SANPHAM c = dl.SANPHAMs.FirstOrDefault(t => t.MASP == msp);
                    if (gioCapNhat.SOLUONGMU > c.SOLUONG)
                        return Json(new { code = 200, msg = "Vướt quá số lượng" }, JsonRequestBehavior.AllowGet);
